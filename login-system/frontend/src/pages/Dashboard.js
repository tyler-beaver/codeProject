    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.metricsGrid}>
                <div style={styles.metricCard} onMouseEnter={e => e.currentTarget.style.transform = 'translateY(-4px)'} onMouseLeave={e => e.currentTarget.style.transform = 'translateY(0)'}>
                ...
                <div style={styles.chartCard}>
                    ...
                    <div style={styles.distributionContainer}>
                        <div style={styles.distributionBar}>
                            <div 
                                style={{...styles.distributionSegment, width: `${(stats.applied/stats.total)*100}%`, backgroundColor: '#3b82f6'}}
                                title={`Applied: ${stats.applied}`}
                            ></div>
                            <div 
                                style={{...styles.distributionSegment, width: `${(stats.interview/stats.total)*100}%`, backgroundColor: '#f59e0b'}}
                                title={`Interview: ${stats.interview}`}
                            ></div>
                            <div 
                                style={{...styles.distributionSegment, width: `${(stats.offer/stats.total)*100}%`, backgroundColor: '#10b981'}}
                                title={`Offer: ${stats.offer}`}
                            ></div>
                            <div 
                                style={{...styles.distributionSegment, width: `${(stats.rejected/stats.total)*100}%`, backgroundColor: '#ef4444'}}
...
function JobForm({ onClose, onAdd, userId }) {
    ...
    return (
        <div style={styles.formOverlay}>
            <div style={styles.formContainer}>
                <div style={styles.formHeader}>
                    <h2 style={{margin: 0, fontSize: '1.5rem', fontWeight: 700, color: '#0f172a'}}>Add New Application</h2>
                ...
                <form onSubmit={handleSubmit} style={styles.form}>
                    ...
                    <div style={styles.formGroup}>
                        <label style={{fontWeight: 700, color: '#0f172a'}}>Salary Range</label>
                        <input 
                            type="text" 
                            name="salary"
                    ...
                    <div style={styles.formButtons}>
                        <button type="submit" style={styles.submitBtn} onMouseEnter={e => e.target.style.background = '#2563eb'} onMouseLeave={e => e.target.style.background = '#3b82f6'}>Create Application</button>
                        <button type="button" style={styles.cancelBtn} onClick={onClose} onMouseEnter={e => e.target.style.background = '#e2e8f0'} onMouseLeave={e => e.target.style.background = '#f1f5f9'}>Cancel</button>
                    </div>
                </form>
            </div>
        </div>
